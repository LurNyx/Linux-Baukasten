...
DESKTOPS = {
    "none": {"title": "Kein Desktop (nur Konsole)", "desc": "Klein und schnell: Server, Rettungssystem, Basteln im Terminal.",
             "packages": (), "size_mb": 0},
    "xfce": {"title": "Xfce", "desc": "Leicht, schnell, klassisch - guter Standard für USB-Sticks und ältere Rechner.",
             "packages": ("live-task-xfce", "task-xfce-desktop"), "size_mb": 650},
    "gnome": {"title": "GNOME", "desc": "Modern und aufgeräumt, wie bei Fedora oder Ubuntu. Größer und braucht mehr RAM.",
              "packages": ("live-task-gnome", "task-gnome-desktop"), "size_mb": 1500},
    "kde": {"title": "KDE Plasma", "desc": "Sehr anpassbar, Windows-ähnliche Bedienung. Groß, aber komfortabel.",
            "packages": ("live-task-kde", "task-kde-desktop"), "size_mb": 1600},
    "lxqt": {"title": "LXQt", "desc": "Sehr leicht und schlank - für alte oder schwache Hardware.",
             "packages": ("live-task-lxqt", "task-lxqt-desktop"), "size_mb": 500},
    "mate": {"title": "MATE", "desc": "Klassischer Desktop im Stil von GNOME 2 - vertraut und stabil.",
             "packages": ("live-task-mate", "task-mate-desktop"), "size_mb": 900},
    "cinnamon": {"title": "Cinnamon", "desc": "Der Desktop von Linux Mint: vertraut, komfortabel, mittelschwer.",
                 "packages": ("live-task-cinnamon", "task-cinnamon-desktop"), "size_mb": 1000},
    "i3": {"title": "i3 (Tiling)", "desc": "Tastaturgesteuerte Kachel-Oberfläche für Fortgeschrittene, extrem schlank.",
           "packages": ("xorg", "lightdm", "i3", "i3status", "dmenu", "rxvt-unicode", "network-manager-gnome"), "size_mb": 350},
}
...
FEATURES_LIST = [
    ...
    F("flatpak", "comfort", "Flatpak und Flathub (zusätzliche Programme)",
      ...
      desktop_extras=(("gnome", ("gnome-software-plugin-flatpak",)), ("kde", ("plasma-discover-backend-flatpak",))), size_mb=25),
...
PRESETS_LIST = [
    Preset("tails-like", "Wegwerf-System (Tails-artig)",
           ...
           "xfce", ("amnesic-full", "hardened-boot", "mac-randomization", "firewall-ufw", "sysctl-hardening", "privacy-tools",
    ...
    Preset("kali-like", "Sicherheits-Werkzeugkasten (Kali-artig)",
           ...
           "xfce", ("pentest-network", "pentest-web", "pentest-wireless", "pentest-passwords", "pentest-forensics", "pentest-reverse",
    ...
    Preset("daily", "Alltags-System (Ubuntu/Mint-artig)",
           ...
           "cinnamon", ("browser-firefox", "mail", "office", "multimedia", "graphics", "printing", "bluetooth", "flatpak",
    ...
    Preset("rescue", "Rettungssystem (SystemRescue-artig)",
           ...
           "lxqt", ("rescue-disk", "rescue-windows", "hardware-diagnose", "pentest-forensics", "toram", "ssh-server", "zram",
    ...
    Preset("developer", "Entwickler-Arbeitsplatz",
           ...
           "kde", ("dev-base", "dev-python", "dev-web", "dev-java", "dev-go-rust", "containers", "editor-geany", "flatpak",
    ...
    Preset("gaming", "Gaming-Live-System",
           ...
           "xfce", ("games-foss", "gaming-tools", "multimedia", "firmware-nonfree", "flatpak", "browser-firefox")),
    ...
    Preset("minimal-desktop", "Leichtes System für alte Rechner",
           ...
           "lxqt", ("browser-firefox", "zram", "firmware-nonfree", "printing", "installer-calamares")),
]
